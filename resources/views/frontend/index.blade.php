            ...
            <div class="container">
                ...
                <div class="featured-categorie-slider owl-carousel">
                    ...
                    <div class="featured-item">
                        ...
                        <div class="text">
                            <h2><a title="{{ $category->category_name }}" href="product.html">{{ Str::length($category->category_name) > 10?Str::substr($category->category_name, 0, 10).'...':$category->category_name }}</a></h2>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="highlight-wrap">
                            ...
                            @foreach ($recent_addeds as $recent_added)
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('uploads/product/preview/') }}/{{ $recent_added->preview }}" alt="">
                                    </div>
                                </div>
                                <div class="content">
                                    <h3><a href="product.html">{{ $recent_added->product_name }}</a></h3>
                                    <div class="rating-product">
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
