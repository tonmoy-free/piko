                    ...
                    <div class="col-lg-12">
                        <form class="wpo-accountWrapper" action="{{route('customerlogin')}}" method="POST">
                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                <div class="alert alert-danger">{{ session('not_verified') }}
                                    <a href="{{ route('customer.email.verify.req') }}">Didn't Get Verify Email</a></div>
                                 @endif
                                <div class="row">
                                ...
                                <ul class="wpo-socialLoginBtn">
                                    <li><button class="bg-danger" tabindex="0" type="button"><span>
                                        ...
                                        class="ti-google"></i></a></span></button></li>
                                    <li>
                                        <button class="bg-secondary" tabindex="0" type="button"><span>
                                            <a href="{{ route('github.redirect') }}"><i
                                                class="ti-github"></i></a></span></button>
                                    </li>
                                </ul>
